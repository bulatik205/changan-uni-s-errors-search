# Changan (Uni S) erors search script

> Проблема: есть большой лог Kernel машины Changan Uni S. Нужно понять, какое уйстройство не работает по `transfer ACK error`
...
1. __Обьявления: `ОТЧЕТ ПО ОШИБКАМ I2C (ACK ERROR)`__
...
2. __Номер I2C шины:__ *⚒️ требует пересмотра*
...
2. __Пояснение:__ коротко рассказывает веротяные причины ошибки
